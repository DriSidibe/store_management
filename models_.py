...
class CameraCamera(models.Model):
...
class StoreBillitems(models.Model):
    quantity = models.IntegerField(blank=True, null=True)
    bill = models.ForeignKey(StoreBill, models.DO_NOTHING, blank=True, null=True)
    product = models.ForeignKey('StoreProduct', models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'store_billitems'
...
class StoreProduct(models.Model):
    ...
    product_id = models.CharField(unique=True, max_length=36)
    product_unity = models.ForeignKey('StoreUnity', models.DO_NOTHING)
...
class StoreRavitaillement(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'store_ravitaillement'


class StoreSell(models.Model):
...
class StoreShelf(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'store_shelf'


class StoreSupplieentrance(models.Model):
    suppler_tel = models.CharField(db_column='Suppler_tel', max_length=255, blank=True, null=True)  # Field name made lowercase.
    image = models.CharField(max_length=100, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'store_supplieentrance'


class StoreUnity(models.Model):
    name = models.CharField(unique=True, max_length=255)

    class Meta:
        managed = False
        db_table = 'store_unity'
